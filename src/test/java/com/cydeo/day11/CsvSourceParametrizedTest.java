...
//            10, 9 , 19
  ...
  @CsvSource({"1, 3 ,4",
    ...
    public void testAddition(int num1, int num2, int sum){
      ...
      Assertions.assertEquals(num1+num2,sum); //This assertions.assertEquals comes from Junit

      assertThat(num1+num2,equalTo(sum));//this asserThat method comes from Hamcrest which comes with RestAssured Library
