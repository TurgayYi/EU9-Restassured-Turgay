 ...
 */
    ...
    @DisplayName("POST with Map to Spartan Class with SpartanUtils")
    @Test
    public void postMethod5(){
        ...
        spartan1 = SpartanUtils.crateANewSpartan();
       ...
       response.prettyPrint();
        ...
        assertThat(response.statusCode(),is(201));
        assertThat(response.path("success"),is(expectedResponseMessage));
        assertThat(response.path("data.name"), is(spartan1.get("name")));
        assertThat(response.path("data.phone"), is(spartan1.get("phone")));
